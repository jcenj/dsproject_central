...
if page == "Homepage":
    ...
    st.image("https://vle.actuaries.org.uk/pluginfile.php/151426/block_awesome/image/0/Working%20Parties-4%20%285%29.png", caption="Your Amazing Banner Image", use_column_width=True)
    st.write("""
...
# Contact Us
    ...
    st.write("- Email: centralchompoopun@gmail.com")
